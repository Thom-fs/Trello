...
class HomeProjetController extends Controller
{
    /**
    ...
    {
        $postsTodoProjet = task_todo::all();

        $postsInprogressProjet = task_inprogress::all();

        $postsFinishedProjet = task_finished::all();


        // dossier trello avec fichier index.blade.php
        return view('trello.indexprojet', compact('postsTodoProjet', 'postsInprogressProjet', 'postsFinishedProjet'));
    }
